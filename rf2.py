...
with r1c2:
    st.markdown("<p style = 'fontSize: 14px; marginTop: 20px; marginLeft: 120px'><b><u> RENEWAL FITNESS FOR HEIGHT/GAS WORK CONFINED  SPACE WORK</u></b><p>", unsafe_allow_html=True)
with r1c3:
...
with r3c1:
    ...
    st.markdown("<b>WEIGHT: </b>", unsafe_allow_html=True)
    st.markdown("<b>HEIGHT WORK FITNESS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;----> </b>", unsafe_allow_html=True)
    st.markdown("<b>GASLINE WORK FITNESS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-----> </b>", unsafe_allow_html=True)
    st.markdown("<b>CONFINED SPACE WORK FITNESS&nbsp;-----> </b>", unsafe_allow_html=True)
